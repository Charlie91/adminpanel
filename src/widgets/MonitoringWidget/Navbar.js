...
export default class Navbar extends React.Component {
  ...
  render() {
    return (
      <header className="col-md-offset-1 col-md-10 col-lg-offset-1 col-lg-10 col-xs-12 header">
          <button onClick={this.props.checkFunction} className="btn btn-primary col-md-offset-0 col-md-3 col-xs-offset-4 col-xs-4">Выполнить проверку</button>
